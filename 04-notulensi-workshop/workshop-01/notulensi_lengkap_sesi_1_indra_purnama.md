...
```mermaid
graph LR
    A["PILAR KIRI: Produk DICINTAI Pengguna (Retention & Product-Market Fit)"] -->|Fondasi Wajib Selesai Terlebih Dahulu| B["PILAR KANAN: Produk DIGUNAKAN BANYAK Pengguna (Scale & Mass Adoption)"]
```
