...
* **Situs Resmi:** `btp.telkomuniversity.ac.id`
* **Instagram Resmi:** `@businessincubator.btp`

---

## 2. Jadwal & Agenda Sesi
...
## 3. Tautan Akses & Kehadiran

* **Platform Pertemuan:** Zoom Cloud Meetings
* **Tautan Langsung:** [Join Zoom Meeting Workshop 1 BTP](https://us06web.zoom.us/j/88304763688?pwd=y6SsxZHF76ynZcLuqDV3rpzxfJNY26.1)
...
## 4. Ketentuan & Tata Tertib Peserta (Changemakers)

1. Seluruh peserta startup perwakilan wajib hadir tepat waktu di kedua sesi (Sesi 1 Pagi dan Sesi 2 Sore).
2. **Kamera Wajib Aktif (*Open Camera*):** Sebagai wujud antusiasme dan komitmen inkubasi, peserta diwajibkan menyalakan kamera sepanjang sesi berlangsung.
3. Peserta diharapkan proaktif mengajukan pertanyaan, mencatat *actionable insights*, dan menghubungkan setiap materi dengan kondisi validasi startup masing-masing (khususnya *problem-customer fit*).
