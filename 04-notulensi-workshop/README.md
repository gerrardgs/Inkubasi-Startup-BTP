...
## Struktur Direktori Workshop:

```
04-notulensi-workshop/
├── README.md                                  # Indeks seluruh workshop & timeline tahapan
└── workshop-01/                               # Workshop Stage 1 (23 September 2026)
    ├── info_dan_poster.md                     # Informasi poster kegiatan, tautan Zoom, presensi BTP
    ├── notulensi_lengkap_sesi_1_indra_purnama.md # Notulensi MASTERCLASS LENGKAP & MENYELURUH (Transkrip B)
    └── notulensi_sesi_2_design_thinking.md    # Notulensi & framework Sesi 2 (Dr. Iwan Iwut Tritoasmoro)
```

---

## Rekapitulasi Rangkaian Workshop:
